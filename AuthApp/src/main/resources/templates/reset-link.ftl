                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Please click the below button to change your password for <strong>Customer Hobby App</strong>.The link will be valid for next ${expirationTime} minutes.</span><br/><br/><span
                                            ...
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Our best, <br/> The Customer Hobby App team</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
