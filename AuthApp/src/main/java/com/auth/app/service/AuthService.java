...
import com.auth.app.exception.PasswordResetLinkException;
import com.auth.app.exception.ResourceAlreadyInUseException;
...
import com.auth.app.model.payload.RegistrationRequest;
import com.auth.app.model.payload.TokenRefreshRequest;
